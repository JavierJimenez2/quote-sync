...
// Icon Imports
import { BellIcon, SettingsIcon, SunFilledIcon, MoonFilledIcon,
  // SearchIcon, 
  Menu2Icon } from 'vue-tabler-icons';
...
// }
import { toggleTheme,isDark } from '@/plugins/vuetify';
